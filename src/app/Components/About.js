      ...
      <div className="sticky top-0">
        {visibleNow && (
          <div className="  bg-sky-700  h-14 w-full   border-2  border-dotted border-white flex items-center justify-center ">
            <button className="bg-orange-400 p-2 rounded-lg sm:text-sm md:text-md lg:text-2xl xl:text-2xl font-bold hover:bg-white ml-auto mx-10">
              <a href="mailto:mitunshil747@gmail.com">Hire Me</a>
            </button>
            <button
              className="bg-orange-400 p-2 rounded-lg sm:text-sm md:text-md lg:text-2xl xl:text-2xl font-bold hover:bg-white "
              onClick={() => {
                setVisibleCV2(true);
              }}
            >
      ...
      <div className="  text-white lg:flex lg:flex-row-reverse lg:justify-center  ">
        ...
        <div className=" flex flex-col lg:justify-evenly lg:w-1/2 items-center justify-center ">
          ...
          <div className=" text-2xl flex-wrap w-auto p-5 lg:text-justify">
            <p>
              A Unique <span className=" text-3xl ">BLOCKCHAIN DEVELOPER.</span>{" "}
              My passion lies in real world problem solving through blockchain
              to enhance ownership and sustainability. I&apos;m committed to
              delivering innovative solutions that meet the unique needs of my
              clients. From crafting decentralized applications to enhancing
              security through smart contracts, I&apos;m dedicated to pushing
